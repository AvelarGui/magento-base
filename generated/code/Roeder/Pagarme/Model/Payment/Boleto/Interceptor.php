<?php
namespace Roeder\Pagarme\Model\Payment\Boleto;

/**
 * Interceptor class for @see \Roeder\Pagarme\Model\Payment\Boleto
 */
class Interceptor extends \Roeder\Pagarme\Model\Payment\Boleto implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Model\Context $context, \Roeder\Pagarme\Helper\Boleto $boletoHelper, \Roeder\Pagarme\Helper\Data $dataHelper, \Magento\Framework\Registry $registry, \Magento\Framework\Api\ExtensionAttributesFactory $extensionFactory, \Magento\Framework\Api\AttributeValueFactory $customAttributeFactory, \Magento\Payment\Helper\Data $paymentData, \Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig, \Magento\Payment\Model\Method\Logger $logger, ?\Magento\Framework\Model\ResourceModel\AbstractResource $resource = null, ?\Magento\Framework\Data\Collection\AbstractDb $resourceCollection = null, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $boletoHelper, $dataHelper, $registry, $extensionFactory, $customAttributeFactory, $paymentData, $scopeConfig, $logger, $resource, $resourceCollection, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAuthorizeResponse');
        if (!$pluginInfo) {
            return parent::getAuthorizeResponse();
        } else {
            return $this->___callPlugins('getAuthorizeResponse', func_get_args(), $pluginInfo);
        }
    }
